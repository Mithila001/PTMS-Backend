...
// import
// com.tritonptms.public_transport_management_system.repository.BusRepository;
...
// import
// com.tritonptms.public_transport_management_system.model.Vehicle.FuelType;
...
// bus.setYearOfManufacture(2022); // Corrected: Add the missing
...
// @Test
// void whenPostInvalidBus_thenStatus400AndErrorMessagesAreReturned() throws
// Exception {
// Bus bus = new Bus();
// bus.setRegistrationNumber("NB-9999");
// bus.setMake("Ashok Leyland");
...
// .andExpect(jsonPath("$.errors.seatingCapacity").value("Seating capacity must
// be at least 1"))
// .andExpect(jsonPath("$.errors.standingCapacity").value("Standing capacity
// must be at least 0"))
// .andExpect(jsonPath("$.errors.busType").value("Bus type is mandatory"))
// .andExpect(jsonPath("$.errors.ntcPermitNumber").value("NTC permit number must
