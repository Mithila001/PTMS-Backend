...
// import
// com.tritonptms.public_transport_management_system.service.ConductorService;
...
// when(conductorService.updateConductor(any(Long.class),
// any(Conductor.class))).thenReturn(updatedMockReturn);
