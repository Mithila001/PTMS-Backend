    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, AuthenticationManager authManager)
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        // USER and above (Routes and Buses - The core public data)
                        .requestMatchers("/api/buses/**")
                        .hasAnyAuthority("ROLE_ADMIN", "ROLE_OPERATIONS_MANAGER", "ROLE_USER")
                        .requestMatchers("/api/routes/**")
                        .hasAnyAuthority("ROLE_ADMIN", "ROLE_OPERATIONS_MANAGER", "ROLE_USER")

                        // OPERATIONS_MANAGER and above (Day-to-day operations - Assignments, Trips,
                        // Employees, Dashboard)
                        .requestMatchers("/api/assignments/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_OPERATIONS_MANAGER")
                        .requestMatchers("/api/scheduled-trips/**")
                        .hasAnyAuthority("ROLE_ADMIN", "ROLE_OPERATIONS_MANAGER")
                        .requestMatchers("/api/drivers/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_OPERATIONS_MANAGER")
                        .requestMatchers("/api/conductors/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_OPERATIONS_MANAGER")
                        .requestMatchers("/api/employees/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_OPERATIONS_MANAGER")
                        .requestMatchers("/api/dashboard/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_OPERATIONS_MANAGER")
                        .requestMatchers("/api/operations/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_OPERATIONS_MANAGER")
                        .requestMatchers("/api/action-logs/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_OPERATIONS_MANAGER")

                        // ADMIN Only Endpoints (Sensitive data/management)
