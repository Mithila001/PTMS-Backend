...
import com.tritonptms.ptms.infrastructure.config.AppProperties;
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http,
                ...
                http
                                ...
                                .authorizeHttpRequests(authorize -> authorize
                                                .requestMatchers("/api/auth/login", "/api/auth/csrf", "/api/enums/**",
                                                                "/actuator/health")
                                                .permitAll()
                                                ...
                                                .requestMatchers("/api/assignments/**", "/api/scheduled-trips/**",
                                                                "/api/drivers/**",
                                                                "/api/conductors/**", "/api/employees/**",
                                                                "/api/dashboard/**")
